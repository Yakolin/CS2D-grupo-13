...
TEST(ServerProtocolTest, ReadPlayerCommandReturnCorrectType)
{
    ...
    player_command_t command =
        static_cast<player_command_t>(PlayerCommandType::MOVE);
...
TEST(ServerProtocolTest, ReadBuyWeapontReturnCorrectObject)
{
    ...
    client_socket.sendall(reinterpret_cast<char *>(&weapon_type),
                          sizeof(weapon_type)); });
    ...
    std::unique_ptr<PlayerAction> action = protocol.read_buy_weapon(player_id);
...
TEST(ServerProtocolTest, ReadBuyAmmoReturnCorrectObject)
{
    ...
    player_command_t command =
        static_cast<player_command_t>(PlayerCommandType::BUY_AMMO);
    client_socket.sendall(reinterpret_cast<char *>(&command), sizeof(command));
    weapon_type_t weapon_type = static_cast<weapon_type_t>(WeaponType::PRIMARY);
    ammo_t ammo_count = 10;
    client_socket.sendall(reinterpret_cast<char *>(&weapon_type),
                          sizeof(weapon_type));
    client_socket.sendall(reinterpret_cast<char *>(&ammo_count),
                          sizeof(ammo_count)); });
    ...
    std::unique_ptr<PlayerAction> action =
        protocol.read_buy_ammo(player_id);

    // Assert
    ASSERT_EQ(command, PlayerCommandType::BUY_AMMO);
    EXPECT_CALL(mock_game, buy_ammo(player_id, WeaponType::PRIMARY, 10))
        .Times(1);
...
TEST(ServerProtocolTest, ReadReloadReturnCorrectObject)
{
    ...
    player_command_t command =
        static_cast<player_command_t>(PlayerCommandType::RELOAD);
    client_socket.sendall(reinterpret_cast<char *>(&command), sizeof(command));
    weapon_type_t weapon_type = static_cast<weapon_type_t>(WeaponType::PRIMARY);
    client_socket.sendall(reinterpret_cast<char *>(&weapon_type),
                          sizeof(weapon_type)); });
    ...
    PlayerCommandType command = protocol.read_player_command();
    std::unique_ptr<PlayerAction> action = protocol.read_reload(player_id);
...
TEST(ServerProtocolTest, ReadShootReturnCorrectObject)
{
    ...
    player_command_t command =
        static_cast<player_command_t>(PlayerCommandType::SHOOT);
    client_socket.sendall(reinterpret_cast<char *>(&command), sizeof(command));
    weapon_type_t weapon_type = static_cast<weapon_type_t>(WeaponType::PRIMARY);
    ammo_t ammo_count = 10;
    client_socket.sendall(reinterpret_cast<char *>(&weapon_type),
    ...
    PlayerCommandType command = protocol.read_player_command();
    std::unique_ptr<PlayerAction> action = protocol.read_shoot(player_id);
...
TEST(ServerProtocolTest, ReadDropWeaponReturnCorrectObject)
{
    ...
    player_command_t command =
        static_cast<player_command_t>(PlayerCommandType::DROP_WEAPON);
    client_socket.sendall(reinterpret_cast<char *>(&command), sizeof(command));
    weapon_type_t weapon_type = static_cast<weapon_type_t>(WeaponType::PRIMARY);
    client_socket.sendall(reinterpret_cast<char *>(&weapon_type),
                          sizeof(weapon_type)); });
    ...
    PlayerCommandType command = protocol.read_player_command();
    std::unique_ptr<PlayerAction> action =
        protocol.read_drop_weapon(player_id);
...
TEST(ServerProtocolTest, ReadPlantBombReturnCorrectObject)
{
    ...
    PlayerCommandType command = protocol.read_player_command();
    std::unique_ptr<PlayerAction> action =
        protocol.read_plant_bomb(player_id);
...
TEST(ServerProtocolTest, ReadDefuseBombReturnCorrectObject)
{
    ...
    PlayerCommandType command = protocol.read_player_command();
    std::unique_ptr<PlayerAction> action =
        protocol.read_defuse_bomb(player_id);
...
TEST(ServerProtocolTest, ReadDropBombReturnCorrectObject)
{
    ...
    player_command_t command =
        static_cast<player_command_t>(PlayerCommandType::DROP_BOMB);
    client_socket.sendall(reinterpret_cast<char *>(&command), sizeof(command)); });
    ...
    PlayerCommandType command = protocol.read_player_command();
    std::unique_ptr<PlayerAction> action =
        protocol.read_drop_bomb(player_id);
