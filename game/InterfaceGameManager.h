#ifndef INTERFACE_GAME_MANAGER_H
#define INTERFACE_GAME_MANAGER_H
#include <cstdint>
#include <utility>
...
public:
    ...
    virtual void shoot(uint16_t player_id, coordinate_t mouse_x, coordinate_t mouse_y) = 0;
    virtual void reload(uint16_t player_id) = 0;
...
#endif  // !INTERFACE_GAME_MANAGER_H
