...
void ManageTexture::drawHealthBar( int x, int y, int width, int height, float healthPercent) {
    ...
    SDL_SetRenderDrawColor(renderer, 255 * (1 - healthPercent), 255 * healthPercent, 0, 255); // Rojo -> Verde
...
bool ManageTexture::load_texture_text(const TextView& id, TTF_Font* fuente, SDL_Color& color, const std::string& text) {
