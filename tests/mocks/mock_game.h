...
public:
    ...
    MOCK_METHOD(void, shoot, (uint16_t player_id, WeaponType weapon_type, ammo_t ammo_count),
                (override));
    ...
    MOCK_METHOD(void, buy_ammo, (uint16_t player_id, WeaponType weapon_type, ammo_t ammo_count),
                (override));
