...
void ScoreBoard::add_ranking(QVBoxLayout *scores_table) {
    ...
    QLabel *label_terrorists = new QLabel(QString::fromStdString(std::to_string(ranking_group.ranking_terrorists)));
    ranking_groups->addRow(new QLabel("terrorists: "), label_terrorists);

    QLabel *label_counter_terrorists = new QLabel(QString::fromStdString(std::to_string(ranking_group.ranking_counter_terrorists)));
